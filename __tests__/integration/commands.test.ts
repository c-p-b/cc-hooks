...
describe('Command Integration Tests', () => {
  ...
  describe('UninstallCommand', () => {
    ...
    it('should handle empty hook list', async () => {
      ...
      expect(consoleLog).toHaveBeenCalledWith(
        expect.stringContaining('No hooks to uninstall')
      );
  ...
  describe('ShowCommand', () => {
    it('should show configured hooks', async () => {
      ...
      expect(consoleLog).toHaveBeenCalledWith(
        expect.stringContaining('2 hooks configured')
      );
      expect(consoleLog).toHaveBeenCalledWith(
        expect.stringContaining('typescript-lint')
      );
      expect(consoleLog).toHaveBeenCalledWith(
        expect.stringContaining('python-lint')
      );
  ...
  describe('MigrateCommand', () => {
    ...
    it('should handle no vanilla hooks', async () => {
      ...
      expect(consoleLog).toHaveBeenCalledWith(
        expect.stringContaining('No vanilla hooks found')
      );
    ...
    it('should not migrate already migrated hooks', async () => {
      ...
      const vanillaHooks = cleanedSettings.hooks.Stop[0].hooks.filter((h: any) => 
        h.command !== 'cc-hooks run'
      );
      expect(vanillaHooks).toHaveLength(0);
